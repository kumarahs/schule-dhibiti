...
<main class="container-fluid">
    ...
    <header class="row">
        ...
        <!-- bouton menu -->
        <a href="" id="menu" data-activates="main_menu" class="btn-colpse right"><i class="material-icons small">menu</i></a>

        <div>
            <div class="side-nav" id="main_menu">
                <p>User name</p>
                <div class="navigation">
                    ...
                    <a href="{{ route('admin') }}"><i class="material-icons small">dashboard</i><span>Dashboard</span></a>
                    <a href="{{ route('login') }}"><i class="material-icons small">person_outline</i><span>Inspecteur</span></a>
                    <a href="{{ route('login') }}"><i class="material-icons small">school</i><span>Ecole</span></a>
                    <a href="{{ route('login') }}"><i class="material-icons small">person</i><span>Administrateur</span></a>
                    <a href="{{ route('login') }}"><i class="material-icons small">account_circle</i><span>Profil</span></a>
                    <a href="{{ route('home') }}"><i class="material-icons small">close</i><span>Déconnexion</span></a>
                </div>
